  ...
  const panes: PaneData[] = room
    ? [
        buildInstructionPane(
          ...
          room.hostAgentLink,
          [
            'Your agent will auto-detect the link and join.',
            '',
        ...
        buildInstructionPane(
          ...
          'guest-agent-join.md',
          'Other Agent (Guest)',
          'Send this to the other person to paste into their agent:',
          room.guestAgentLink,
          [
            'Their agent will auto-detect the link and join.',
            '',
            'Press e during chat to edit a reply before it sends.',
          ],
          `Join this chat now: ${room.guestAgentLink}`,
        ),
      ]
    : [];
