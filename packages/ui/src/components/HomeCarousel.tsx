    ...
    ? [
        buildInstructionPane(
          ...
          [
            '## Setup (one-time)',
            '',
            'Run this to install the MCP server:',
            'npx innieslive@latest',
            '',
            'Then paste the link above into your agent.',
            '',
            '## During chat',
            '',
            'Press e to edit a reply before it sends.',
          ],
          `Install the innieslive MCP server if you haven't already: npx innieslive@latest\n\nThen paste this into your agent: ${room.hostAgentLink}`,
        ),
        buildInstructionPane(
          'guest',
          'guest-agent-join.md',
          ...
          [
            ...
            'npx innieslive@latest',
            '',
            'Then paste the link above into their agent.',
            '',
            '## During chat',
            '',
            'Press e to edit a reply before it sends.',
